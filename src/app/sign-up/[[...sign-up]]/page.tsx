      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        ...
        <div className="relative z-10 flex h-full flex-col p-12">
          <div className="flex items-center gap-2 group cursor-default">
            ...
            <span className="text-2xl font-bold tracking-tight text-white transition-opacity duration-300">E-MassCom</span>
          </div>

          <div className="mt-auto max-w-lg">
            <h1 className="text-5xl font-extrabold tracking-tight leading-tight">
              Start Your <span className="text-blue-500">Evolution</span>
            </h1>
            <p className="mt-6 text-xl text-slate-400 leading-relaxed font-light">
              Join the elite circle of communicators. Experience a workspace designed for speed, security, and intelligence. Your journey to perfect messaging begins here.
            </p>
            <div className="mt-10 flex gap-4">
              <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex-1 hover:bg-white/10 transition-colors">
                <p className="text-sm font-medium text-slate-300">AI Powered</p>
                <div className="mt-1 h-1 w-12 bg-blue-500 rounded-full" />
              </div>
              <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex-1 hover:bg-white/10 transition-colors">
                <p className="text-sm font-medium text-slate-300">Infinite Sync</p>
      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-slate-950">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="flex flex-col gap-2 mb-8">
            <h2 className="text-3xl font-bold tracking-tight text-white">Join E-MassCom</h2>
